function [qext, qsca, qabs, qback, gsca, qratio] = Miecoated(y,x,m2,m1,opt)
...
if x==y                     % To reduce computing time
    ...
    [qext, qsca, qabs, qback, gsca]=Mie(y,m1);

elseif x==0                 % To avoid a singularity at x=0

    [qext, qsca, qabs, qback, gsca]=Mie(y,m2);

elseif m1==m2

    [qext, qsca, qabs, qback, gsca]=Mie(y,m1);       % To reduce computing time
